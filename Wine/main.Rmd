...
p2 + geom_pointrange(aes(xmin = points_mean - points_sd,
  ...
  scale_x_continuous(limits = c(83,95), expand = c(0,0.5), breaks = pretty_breaks(n = 8)) +
...
p + geom_smooth(method='gam', colour='tomato', se = FALSE, size=0.8, alpha=0.75) +
  ...
  #             size=0.5,
  #             alpha=0.5) +
  geom_point(aes(color = continent), size = 2, alpha = 0.5) +
